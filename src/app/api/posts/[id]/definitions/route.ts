...
/**
 * GET /api/posts/[id]/definitions
 * Obtiene todas las definiciones con anclas de un post
  ...
  try {
    ...
    if (post.authorId !== user.id) {
      return NextResponse.json(
        {
          error: 'Forbidden',
          message: 'No tienes permiso para acceder a las definiciones de este post',
        },
        { status: 403 }
      );
    }
